if not shared.VoidDev then
	...
	if isfile and isfile("vape/loader.lua") then
		loadstring(readfile("vape/loader.lua"), "loader")()
		return
	elseif isfile and isfile("loader.lua") then
		loadstring(readfile("loader.lua"), "loader")()
		return
	else
		pcall(function()
			loadstring(game:HttpGet("https://code.sarris.dev/voidware/VWRewrite/update11/loader.lua", true), "loader")()
		end)
		return
	end
end
...
task.spawn(function()
	pcall(function()
		...
		loadstring(game:HttpGet("https://code.sarris.dev/voidware/VWExtra/main/VWUpdateLog.lua", true))()
		...
		if (not teleportedServers) and not shared.VapeIndependent and not shared.DISABLED_QUEUE_ON_TELEPORT and not shared.FORCE_DISABLED_QUEUE_ON_TELEPORT then
			...
			local teleportScript = [[
				...
				if shared.VapeDeveloper and isfile('vape/loader.lua') then
					...
					loadstring(game:HttpGet('https://code.sarris.dev/voidware/VWRewrite/'..readfile('vape/profiles/commit.txt')..'/loader.lua', true), 'loader')()
				end
			]]
