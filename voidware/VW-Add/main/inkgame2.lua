...
----------------------------------------------------------------------------
  ...
  loadstring(game:HttpGet("https://code.sarris.dev/voidware/VW-Add/main/loader.lua", true))()
...
if IS_DOWN and not shared.BYPASS_VW_PROTECTION then
    ...
    if shared.VW_PUBLIC_TESTING_MODE then
        local RESULT_HANDLER = Instance.new("BindableFunction")
        RESULT_HANDLER.OnInvoke = function(text : string)
            loadstring(game:HttpGet("https://code.sarris.dev/voidware/VW-Add/"..tostring(commit).."/something.lua", true))()
        end
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Voidware Public Testing",
    ...
    task.spawn(function()
        pcall(function()
            ...
            --loadstring(game:HttpGet("https://code.sarris.dev/voidware/VW-Add/"..tostring(commit).."/inkgamereducer.lua", true))()
        end)
    end)

    loadstring(game:HttpGet("https://code.sarris.dev/voidware/VW-Add/"..tostring(commit).."/newinkgame.lua", true))()
end
