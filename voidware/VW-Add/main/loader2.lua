...
shared.VoidwareBedwarsLoadingDebug = true
...
local meta = {
	[0] = {
		title = "Universal",
		dev = "vwdev/vwrw.lua",
		script = "https://code.sarris.dev/voidware/VWRewrite/" .. (shared.CustomCommit and tostring(
			shared.CustomCommit
	...
	[7008097940] = {
		...
		script = "https://code.sarris.dev/voidware/VW-Add/" .. (shared.CustomCommit and tostring(
			shared.CustomCommit
		) or "main") .. "/inkgame.lua",
	},
	[6331902150] = {
